...
<div class="project-part">
    ...
    <div class="p-body" style="width:100%;">
                     ...
                     <div class="card-title flex" style="margin: 0;">
                        <div class="flex items-center" style="margin: 0; width: 100%;">
                           ...
                           <div class="flex" style="width: 100%;">
                              ...
                              <i class="fa-regular fa-comment" style="font-size:23px; margin: 0; margin-left: auto; position:relative;">
                              <div style="z-index:1; position:absolute; top:20%; right:33%; font-weight:bolder; color:red; font-size:11px;">&nbsp;&nbsp;${issue.ISSUEREPLY_COUNT }</div>
                              </i>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="flex items-center justify-between">
                        ...
                        <div style="margin: 0; padding: 0; line-height:20px;">
                              ...
                              <c:if test="${issue.ISSUE_STATUS == '1'}">
                                 <div class="badge badge-success gap-2" style="font-size: 12px; margin: 0; background-color:blue;color:white;">진행중</div>
                              </c:if>
         ...
         <div class="modal_content">
            <div class="flex card-body" style="padding-bottom:0px;">
               <div class="navbar text-neutral-content" style="width: 100%; padding: 0px; min-height: 1rem; height: 30px; border-bottom:3px solid #016fa0;">
                  <div class="text-black mb-3" style="font-weight: bold; font-size: 1.5rem; ">
                     ...
                     <input type="hidden" name="membernum" value="${member.MEMBER_NUM }" />     <%-- ${issue.MEMBER_NUM} --%>
            ...
            <div class="container flex flex-col card-body" style="padding-top:10px; padding-bottom:10px;">
               <div class="flex">
                  ...
                  <select class="w-24 h-8 text-center pr-2" style="height:48px; border:1px solid #aaaaaa; border-right:0px;" name="issueimp" id="issue_imp">
                        <option value=0 selected>중요도</option>
                        <option value=3>중&nbsp;&nbsp;요</option>
                        <option value=2>보&nbsp;&nbsp;통</option>
                        <option value=1>낮&nbsp;&nbsp;음</option>
                  </select>
                  <input type="text" id="issue_title" name="issuetitle" placeholder="제목을 입력하세요." class="input" style="border:1px solid #aaaaaa; border-radius:0px; width:638px; justify-content:space-between;">
               </div>
               
               <div class="flex justify-center">
                  <div class="flex items-center justify-center" style="border:1px solid #aaaaaa; border-radius:0px; width:150px; border-right:0">${member.MEMBER_NAME}</div>
                  
                  <input id='issue_regdate' type="date" class="input" name="issueregdate" style="border:1px solid #aaaaaa; border-radius:0px; width:350px; justify-content:space-between; border-right:0;">
                  ...
                  <input id="issue_deadline" type="date" class="input" name="issuedeadline" style="border:1px solid #aaaaaa; border-radius:0px; width:350px; justify-content:space-between; border-left:0;">
               </div>
               
               
               <!-- 내용 -->   
               <textarea class="textarea" name="issuecontent" id="issue_content" class="form-control" style="height:150px;width:100%; resize:none; border:1px solid #aaaaaa; border-radius:0px;" placeholder="내용을 작성하세요."></textarea>
...
<!-- project/list.jsp 화면끝나는 태그 -->
      ...
      <script>
      	if (${ISSUE_NUMM} !== null && ${ISSUE_NUMM} !== 0) {
          window.open('issue_detail?ISSUE_NUM=' + ${ISSUE_NUMM}, '이슈 상세', 'width=1150px,height=730px,left=500px,top=150px');
      	}
